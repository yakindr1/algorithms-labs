...
Задача H просит построить перестановку, на которой быстрая сортировка со срединным опорным сделает наибольшее число сравнений. Генератор лежит в `research/generators.py`, проверка на своей же реализации:
